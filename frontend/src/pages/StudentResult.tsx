...
const StudentResult: React.FC = () => {
    ...
    const totalMarks = student.marks?.reduce((sum: number, m: any) => sum + m.total, 0) ?? 0;
    const maxMarks = (student.marks?.length ?? 0) * 100;
                ...
                >
                    ...
                    <div style={{ padding: 'clamp(1.5rem, 5vw, 2rem)', background: '#FAFAF9', borderBottom: '1px solid #E7E5E4' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.25rem' }}>
                            {[
                                { label: 'Student Name', value: student.first_name },
                                { label: 'USN / Roll No.', value: student.usn },
